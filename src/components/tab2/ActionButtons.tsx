  ...
  return (
    <div className="save-button-area border-t border-gold-medium/30 pt-3 bg-transparent flex-shrink-0">
      ...
      <button
        ...
        id="runAiMatchButton"
        className={`w-full mb-2 py-3 px-4 rounded-xl text-xs font-bold tracking-widest uppercase shadow transition-all duration-200 cursor-pointer text-center flex items-center justify-center gap-2 ${
      ...
      <button
        ...
        className={`w-full flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-center text-xs font-bold uppercase tracking-widest shadow transition-all duration-200 ${
